...
public interface PrerecordedSpeechStorage {
    ...
    String getMessageHash(Actor actor, Voice voice, String hash) throws IOException;

    void deleteMessage(Actor actor, Voice voice, String hash);

    void storeSpeechResource(Actor actor, Voice voice, String hash, InputStream inputStream, String name)
            throws IOException;
    ...
    void writeStringResource(Actor actor, Voice voice, String hash, String name, String value) throws IOException;
