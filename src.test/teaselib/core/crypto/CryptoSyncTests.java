...
public class CryptoSyncTests {
    ...
    final static List<String> testFiles = Arrays.asList("test (1).png", "test (2).png", "more/test (3).png",
            "more/test (4).png", "marquis1.jpg", "more/marquis2.jpg");

    @Test
    public void testFileNaming() throws Exception {
        CryptoSync cryptoSync = new CryptoSync(decryptedTestData, encryptedTestData);
     ...
     */
    // @Test
    public void createEncryptedTestData() throws IOException, GeneralSecurityException {
        CryptoSync cryptoSync = new CryptoSync(decryptedTestData, encryptedTestData);
        cryptoSync.sync();
    }
    ...
    public void testFileSync() throws IOException, GeneralSecurityException {
        ...
        for (String name : testFiles) {
            ...
            assertTrue(FileUtilities.sameContent(cryptoSync.getDecryptedFile(name),
    ...
    public void testFileFilter() throws GeneralSecurityException, IOException {
        assertEquals(2,
                new CryptoSync(decryptedTestData, encryptedTestData, FileUtilities.getFileFilter("jpg")).size());
        assertEquals(4,
