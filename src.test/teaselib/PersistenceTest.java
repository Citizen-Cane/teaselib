...
public class PersistenceTest {
    ...
    public void testPersistentFloat() {
        ...
        assertEquals(Double.toString(testValue), script.teaseLib
                .getString(TeaseLib.DefaultDomain, script.namespace, name));
        ...
        assertEquals(Double.toString(TeaseLib.PersistentFloat.DefaultValue),
                script.teaseLib.getString(TeaseLib.DefaultDomain,
                        script.namespace, name));
        assertTrue(f.available() == true);
        script.teaseLib.clear(TeaseLib.DefaultDomain, script.namespace, name);
        assertTrue(f.available() == false);
    ...
    public void testPersistentFloatDefault() {
        ...
        assertEquals(Double.toString(testDefaultValue), script.teaseLib
                .getString(TeaseLib.DefaultDomain, script.namespace, name));
        f.clear();
        assertTrue(f.available() == false);
        assertTrue(f.value() == testDefaultValue);
    ...
    public void testPersistentInteger() {
        ...
        assertEquals(Integer.toString(testValue), script.teaseLib
                .getString(TeaseLib.DefaultDomain, script.namespace, name));
    ...
    public void testPersistentIntegerDefault() {
        ...
        assertEquals(Integer.toString(testDefaultValue),
                script.getString(name));
        assertEquals(Integer.toString(testDefaultValue), script.teaseLib
                .getString(TeaseLib.DefaultDomain, script.namespace, name));
        i.clear();
        assertTrue(i.available() == false);
        assertTrue(i.value() == testDefaultValue);
    ...
    public void testPersistentString() {
        ...
        assertEquals(testValue, script.teaseLib
                .getString(TeaseLib.DefaultDomain, script.namespace, name));
        assertTrue(i.available() == true);
        i.clear();
        assertEquals(null, script.getString(name));
        ...
        assertEquals(TeaseLib.PersistentString.DefaultValue,
                script.getString(name));
        assertEquals(TeaseLib.PersistentString.DefaultValue, script.teaseLib
                .getString(TeaseLib.DefaultDomain, script.namespace, name));
        assertTrue(i.available() == true);
        script.teaseLib.clear(TeaseLib.DefaultDomain, script.namespace, name);
        assertTrue(i.available() == false);
    ...
    public void testPersistentStringDefault() {
        ...
        assertEquals(testDefaultValue, script.teaseLib
                .getString(TeaseLib.DefaultDomain, script.namespace, name));
        i.clear();
        assertTrue(i.available() == false);
        assertTrue(i.value() == testDefaultValue);
