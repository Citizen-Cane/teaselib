...
public class PhrasesTest {
    ...
    public void testPhrasesOfStrings()
        ...
        assertEquals(Phrases.rule(1, Phrases.oneOf(Phrases.COMMON_RULE, "of course")), phrases.get(1));
    ...
    @Test
    public void testDistinctPhrases()
            throws TransformerFactoryConfigurationError, TransformerException, ParserConfigurationException {
        String[] yes = { //
                "Yes Miss, of course", //
                "Of course, Miss" };
    ...
    @Test
    public void testPhraseGroupingOfChoices()
            throws TransformerFactoryConfigurationError, ParserConfigurationException, TransformerException {
        String[] yes = { //
                "Yes Miss, of course", //
                "Yes, of course, Miss", //
