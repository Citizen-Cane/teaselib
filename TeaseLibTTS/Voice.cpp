...
jobject getGenderField(JNIEnv *env, const wchar_t* gender)
{
	...
	jclass genderClass = JNIClass::getClass(env, "teaselib/texttospeech/Voice$Gender");
	jobject genderValue = env->GetStaticObjectField(
		genderClass,
		JNIClass::getStaticFieldID(env, genderClass, genderFieldName, "Lteaselib/texttospeech/Voice$Gender;"));
	return genderValue;
}
...
, pVoiceToken(pVoiceToken)
{
	...
	static const char* voiceClass = "teaselib/texttospeech/Voice";
