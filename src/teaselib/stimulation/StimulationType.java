...
public enum StimulationType {
    ...
    public static StimulationController<StimulationType> stimulateAnusAndBalls(
        ...
        stim.add(StimulationType.Walk,
                new Walk(stim.stimulator(StimulationRegion.Anus)));
        stim.add(StimulationType.Trot,
                new Trot(stim.stimulator(StimulationRegion.Anus)));
        stim.add(StimulationType.Run,
                new Run(stim.stimulator(StimulationRegion.Anus)));
        stim.add(StimulationType.Attention,
                new Attention(stim.stimulator(StimulationRegion.Anus)));
        stim.add(StimulationType.Whip,
                new Whip(stim.stimulator(StimulationRegion.Balls)));
        stim.add(StimulationType.Punish,
                new Punish(stim.stimulator(StimulationRegion.Balls)));
    ...
    public static StimulationController<StimulationType> stimulateCockAndBalls(
        ...
        stim.addRegion(StimulationRegion.Balls, balls);
        stim.add(StimulationType.Walk,
                new Walk(stim.stimulator(StimulationRegion.Cock)));
        stim.add(StimulationType.Trot,
                new Trot(stim.stimulator(StimulationRegion.Cock)));
        stim.add(StimulationType.Run,
                new Run(stim.stimulator(StimulationRegion.Cock)));
        stim.add(StimulationType.Attention,
                new Attention(stim.stimulator(StimulationRegion.Cock)));
        stim.add(StimulationType.Whip,
                new Whip(stim.stimulator(StimulationRegion.Balls)));
        stim.add(StimulationType.Punish,
                new Punish(stim.stimulator(StimulationRegion.Balls)));
        stim.add(StimulationType.Tease,
                new Tease(stim.stimulator(StimulationRegion.Cock)));
        stim.add(StimulationType.Cum,
                new Cum(stim.stimulator(StimulationRegion.Cock)));
        return stim;
    }
    ...
    public static StimulationController<StimulationType> stimulateCockAndAnus(
        ...
        stim.add(StimulationType.Attention,
                new Attention(stim.stimulator(StimulationRegion.Cock)));
        stim.add(StimulationType.Whip,
                new Whip(stim.stimulator(StimulationRegion.Anus), 0.0));
        stim.add(StimulationType.Punish,
                new Punish(stim.stimulator(StimulationRegion.Anus)));
        stim.add(StimulationType.Tease,
                new Tease(stim.stimulator(StimulationRegion.Cock)));
        stim.add(StimulationType.Cum,
                new Cum(stim.stimulator(StimulationRegion.Cock)));
