 ...
 */
public enum Toys {
    Ankle_Cuffs, Anal_Dildo, Anal_Beads, Ass_Hook, Baby_Oil, Ball_Gag, Ball_Stretcher, Bells, Belt, Ben_Wa_Balls, Bit_Gag, Blindfold, Breast_Forms, Buttplug, Camera, Candle, Cane, Chains, Chastity_Belt, Chastity_Cage, Cigarette, Clothespins, Cockring, Collar, Condoms, Crop, Diaper, Dildo, Dog_Collar, Duct_Tape, Doll, Enema_Bulb, Enema_Kit, Estim, Flogger, Gates_Of_Hell, Hairbrush, Handcuffs, Harness, Heat_Rub, Hood, Humbler, Husband, Ice_Tray, Inflatable_Buttplug, Inflatable_Dildo, Leash, Leather_Ankle_Cuffs, Leather_Wrist_Cuffs, Lube, Muzzle_Gag, Nipple_clamps, Paddle, Padlocks, Penis_Gag, Penis_Pump, Plants, Posture_Collar, Princess_Crown, Pussy_Clamps, Ring_Gag, Rope, Rubber_bands, Ruler, Shoe_Lace, Shrinkwrap, Spreader_Bar, Strap_On, Tampon, Vibrating_Buttplug, Vibrating_Dildo, Vibrating_Egg, Vibrator, Wax, Weights, Whip, Wife, Wooden_Spoon;
