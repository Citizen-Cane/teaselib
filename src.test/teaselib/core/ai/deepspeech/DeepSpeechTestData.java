...
public class DeepSpeechTestData {
    ...
    static final DeepSpeechTestData AUDIO_2830_3980_0043_RAW = new DeepSpeechTestData(
            DeepSpeechRecognizer.model.resolve(Path.of(Locale.ENGLISH.getLanguage(), "audio/2830-3980-0043.raw")), //
    ...
    static final DeepSpeechTestData AUDIO_4507_16021_0012_RAW = new DeepSpeechTestData(
            DeepSpeechRecognizer.model.resolve(Path.of(Locale.ENGLISH.getLanguage(), "audio/4507-16021-0012.raw")), //
    ...
    static final DeepSpeechTestData AUDIO_8455_210777_0068_RAW = new DeepSpeechTestData(
            DeepSpeechRecognizer.model.resolve(Path.of(Locale.ENGLISH.getLanguage(), "audio/8455-210777-0068.raw")), //
