...
void AudioLevelSignalProblemOccuredEvent::fire(const SPINTERFERENCE interference)
{
	...
	jclass audioSignalProblemClass = JNIClass::getClass(env, "teaselib/speechrecognition/SpeechRecognition$AudioSignalProblem");
	jobject audioSignalProblem = env->GetStaticObjectField(
		audioSignalProblemClass,
		JNIClass::getStaticFieldID(env, audioSignalProblemClass, audioSignalProblemFieldName, "Lteaselib/speechrecognition/SpeechRecognition$AudioSignalProblem;"));
	jclass eventClass = JNIClass::getClass(env, "teaselib/speechrecognition/events/AudioSignalProblemOccuredEventArgs");
	jobject eventArgs = env->NewObject(
		eventClass,
		JNIClass::getMethodID(env, eventClass, "<init>", "(Lteaselib/speechrecognition/SpeechRecognition$AudioSignalProblem;)V"),
		audioSignalProblem);
