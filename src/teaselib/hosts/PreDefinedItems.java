    ...
    protected Item[] createUserItems(TeaseLib teaseLib, String domain, Object item) {
        if (item == Toys.Buttplug) {
            ...
            Item vibratingButtplug = item(teaseLib, item, "Toys", "vibrating_buttplug",
                    "A vibrating buttplug", Features.Teasing, Features.Anal, Toys.Anal.Plug);
            Item inflatableButtplug = item(teaseLib, item, "Toys", "inflatable_buttplug",
                    "An inflatable buttplug", Features.Inflatable, Features.Anal, Toys.Anal.Plug);
            Item analBeads = item(teaseLib, item, "Toys", "anal_beads", "Anal Beads", Features.Anal,
                    Toys.Anal.Beads);
            ...
            Item leatherWristCuffs = item(teaseLib, item, "Toys", "leather_wrist_cuffs",
                    "Leather wrist cuffs", Material.Leather, Features.Detachable);
            ...
            Item bitGag = item(teaseLib, item, "Toys", "bit_gag", "A bit gag", Toys.Gags.Bit_Gag,
                    Material.Rubber);
            Item muzzleGag = item(teaseLib, item, "Toys", "muzzle_gag", "A muzzle gag",
                    Toys.Gags.Muzzle_Gag, Material.Leather);
            Item penisGag = item(teaseLib, item, "Toys", "penis_gag", "A penis gag",
                    Toys.Gags.Penis_Gag, Material.Rubber);
            Item ringGag = item(teaseLib, item, "Toys", "ring_gag", "A ring gag",
            ...
            Item cane = item(teaseLib, item, "Toys", "cane", "A cane",
                    Toys.Spanking_Implements.Cane, Material.Wood);
            Item whip = item(teaseLib, item, "Toys", "whip", "A whip",
            ...
            Item hairbrush = item(teaseLib, item, "Toys", "hairbrush", "A hairbrush",
                    Toys.Spanking_Implements.Hairbrush, Material.Wood);
            Item woodenSpoon = item(teaseLib, item, "Toys", "wooden_spoon", "A wooden spoon",
                    Toys.Spanking_Implements.Wooden_Spoon, Material.Wood);
            ...
            Item slaveCollar = item(teaseLib, item, "Toys", "collar", "A slave collar",
            ...
            Item vibratingDildo = item(teaseLib, item, "Toys", "vibrating_dildo",
                    "A vibrating dildo", Material.Rubber, Features.Vaginal, Features.Teasing);
            ...
            Item vibratingEgg = item(teaseLib, item, "Toys", "vibrating_egg", "Vibrating egg",
                    Toys.Vaginal.VibratingEgg, Features.Teasing);
            Item benWaBalls = item(teaseLib, item, "Toys", "ben_wa_balls", "Ben Wa Balls",
                    Toys.Vaginal.Ben_Wa_Balls, Features.Teasing);
