...
public class WindowedMeanTest {
    ...
    public void simulateThrowRetrieve() {
        Assertions.assertEquals(Arrays.asList(WindowedMean.Result.ADJUSTING, WindowedMean.Result.ADJUSTING,
                WindowedMean.Result.ADJUSTING, WindowedMean.Result.GOOD_ACCEPTED, WindowedMean.Result.TOO_HIGH,
                WindowedMean.Result.GOOD_LOW, WindowedMean.Result.GOOD_ACCEPTED, WindowedMean.Result.TOO_HIGH), simulateThrowAndRetrieveTiming(new Double[]{5.0, 10.0, 12.0, 9.0, 13.0, 8.0, 9.0, 12.0}));
    }
    ...
    public void simulateThrowRetrieve2() {
        Assertions.assertEquals(Arrays.asList(WindowedMean.Result.ADJUSTING, WindowedMean.Result.ADJUSTING,
                ...
                WindowedMean.Result.GOOD_HIGH, WindowedMean.Result.TOO_HIGH), simulateThrowAndRetrieveTiming(new Double[]{12.0, 10.0, 8.0, 6.0, 5.0, 7.0, 8.0}));
    }
